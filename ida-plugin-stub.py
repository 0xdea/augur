...
class AugurStub(idaapi.plugin_t):
    ...
    def init(self):
        print(
            "[WARN] augur is a headless plugin based on idalib's Rust bindings and should be installed via the "
            "`augur` crate in crates.io or from source, not as a regular IDA plugin."
        )
